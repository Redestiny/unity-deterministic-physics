        ...
        )
        {
            primaryConeAndTwist = new PhysicsJoint
            {
                ...
                m_Constraints = new FixedList128Bytes<Constraint>
                {
                    ...
                    [k_RagdollPrimaryMaxConeIndex]    = Constraint.Cone(0, new FloatRange(0f, math.min(math.abs(maxConeAngle), math.PI)))
                }
            };
            ...
            perpendicularCone = new PhysicsJoint
            {
                ...
                m_Constraints = new FixedList128Bytes<Constraint>
                {
                    ...
                    [k_RagdollPerpendicularRangeIndex + 1] = Constraint.BallAndSocket()
                }
            };
        }
